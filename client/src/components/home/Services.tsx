...
const Services = () => {
  return (
    <section className="py-12 bg-neutral-100 dark:bg-gray-800 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-secondary dark:text-white">Our Services</h2>
        ...
        <div className="mt-10 grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            <div key={service.id} className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-md service-card">
              ...
              <h3 className="text-xl font-semibold text-secondary dark:text-white">{service.title}</h3>
              <p className="mt-2 text-gray-500 dark:text-gray-300">
                {service.description}
              </p>
              <Link href={service.link} className="mt-4 inline-flex items-center text-primary dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">
                Learn More 
