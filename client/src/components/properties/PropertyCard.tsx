...
const PropertyCard = ({ property, onClick, featured }: PropertyCardProps) => {
  ...
  return (
    <div 
      className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl property-card cursor-pointer" 
      onClick={onClick}
    >
      ...
      <div className="p-6">
        <div className="flex justify-between items-start">
          <div>
            <h3 className="text-lg font-semibold text-secondary dark:text-white hover:text-primary dark:hover:text-blue-400 transition-colors duration-200">{title}</h3>
        ...
        <div className="mt-4">
          <button className="text-primary dark:text-blue-400 font-medium hover:text-blue-700 dark:hover:text-blue-300 border-0 bg-transparent cursor-pointer p-0 flex items-center transition-colors duration-200">
